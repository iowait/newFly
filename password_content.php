...
<b><?=$PasswordRule?></b>
    ...
    <form id="inputform" method='post' action='password.php'>
      ...
      <table cellpadding = '10'>
        ...
        <tr>
          <td colspan='2'>
            ...
            <input type='submit' onClick="return checkSubmit('Change your password','Are you sure you remember the new value?')"  value='Change password'>
          </td>
        </tr>
      </table>
